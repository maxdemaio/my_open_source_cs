...
[Linear Algebra](https://www.edx.org/course/linear-algebra-foundations-to-frontiers) | UT Austin | 15 weeks | 6-10 hours/week | self-paced | Pre-calculus | 🟧 (Studying)
...
- Books/Literature/E-reading: [How to Break into Tech](https://haseebq.com/how-to-break-into-tech-job-hunting-and-interviews/), Cracking the Coding Interview (Book/YT series), [Hired in Tech - System Design](https://www.hiredintech.com/system-design), [Automate the Boring Stuff with Python](https://automatetheboringstuff.com/), [Big-O Algorithm Cheat Sheet](https://www.bigocheatsheet.com/), and [Hacker News](https://news.ycombinator.com/)
